...
void mediaPorSensor(float medias[SENSORES], int *operacoes) {
  *operacoes = 0;
  for (int i = 0; i < SENSORES; i++) {
    float soma = 0;
    for (int j = 0; j < HORAS; j++) {
...
float encontrarMaior(int *sensorMaior, int *horaMaior, int *operacoes) {
  float maior = sensores[0][0];
  *sensorMaior = 0;
  *horaMaior = 0;
  *operacoes = 0;
  for (int i = 0; i < SENSORES; i++) {
...
float mediaGeral(int *operacoes) {
  float soma = 0;
  *operacoes = 0;
  for (int i = 0; i < SENSORES; i++) {
    for (int j = 0; j < HORAS; j++) {
...
int contarAcimaLimite(float limite, int *operacoes) {
  int contador = 0;
  *operacoes = 0;
  for (int i = 0; i < SENSORES; i++) {
    for (int j = 0; j < HORAS; j++) {
